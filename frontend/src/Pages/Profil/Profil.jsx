    ...
    <div className="min-h-screen bg-gray-100 p-8 flex flex-col items-center">
      ...
      <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-4xl">
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div>
            <label htmlFor="email" className="block text-base font-medium mb-2 text-gray-700">Email<span className="text-red-500">*</span></label>
            <input type="email" id="email" name="email" value={formData.email} onChange={handleChange} disabled={!isEditing} required 
                   className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"/>
          </div>
          <div>
            <label htmlFor="NIK" className="block text-base font-medium mb-2 text-gray-700">NIK<span className="text-red-500">*</span></label>
            <input type="text" id="NIK" name="NIK" value={formData.NIK} onChange={handleChange} disabled={!isEditing} required maxLength="16" pattern="\d{16}"
                   className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"/>
          </div>
          <div>
            <label htmlFor="allergies" className="block text-base font-medium mb-2 text-gray-700">Alergi</label>
            <textarea id="allergies" name="allergies" rows="3" value={formData.allergies} onChange={handleChange} disabled={!isEditing} 
          ...
          <div>
            <label htmlFor="disease_histories" className="block text-base font-medium mb-2 text-gray-700">Riwayat Penyakit</label>
            <textarea id="disease_histories" name="disease_histories" rows="5" value={formData.disease_histories} onChange={handleChange} disabled={!isEditing} 
